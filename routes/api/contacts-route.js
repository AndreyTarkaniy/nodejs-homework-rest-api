...
import { upload,isValideId, authenticate } from "../../middleware/index.js";
...
contactsRouter.post("/",upload.single("avatar"), validateBody(schema.contactsAddSchema), control.add);
